...
public class Camera {
	...
	public void centerOnTarget() {
		position.setX(target.getPosition().getX() - Settings.WINDOW_WIDTH / 2 + target.getWidth() / 2);
		position.setY(target.getPosition().getY() - Settings.WINDOW_HEIGHT / 2 + target.getHeight() / 2);
